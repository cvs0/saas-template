...
export default function CollaborativeDocument() {
  ...
  return (
    <div className="bg-gradient-to-b from-gray-600/10 to-black text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-start md:justify-center gap-8 lg:gap-16">
          <div className="md:w-[320px] p-4 md:p-8 flex flex-col md:sticky md:top-24">
            <h1 className="text-2xl font-semibold leading-tight mb-6">Ideate and specify what to build next</h1>

            <div className="space-y-1">
              <button
                className={`flex items-center text-left w-full px-3 py-2 rounded-md transition-colors hover:cursor-pointer ${
                  activeTab === "collaborative" ? "text-white" : "text-gray-400 hover:text-gray-300"
                }`}
                onClick={() => setActiveTab("collaborative")}
              >
                <div
                  className={`w-1 h-5 mr-3 rounded-sm ${
                    activeTab === "collaborative" ? "bg-green-500" : "bg-gray-600/50"
                  }`}
                ></div>
              ...
              <button
                className={`flex items-center text-left w-full px-3 py-2 transition-colors hover:cursor-pointer ${
                  activeTab === "inline" ? "text-white" : "text-gray-400 hover:text-gray-300"
                }`}
                onClick={() => setActiveTab("inline")}
              >
                <div
                  className={`w-1 h-5 mr-3 rounded-sm ${activeTab === "inline" ? "bg-green-500" : "bg-gray-600/50"}`}
                ></div>
                Inline comments
              </button>
              ...
              <button
                className={`flex items-center text-left w-full px-3 py-2 rounded-md transition-colors hover:cursor-pointer ${
                  activeTab === "text-to-issue" ? "text-white" : "text-gray-400 hover:text-gray-300"
                }`}
                onClick={() => setActiveTab("text-to-issue")}
              >
                <div
                  className={`w-1 h-5 mr-3 rounded-sm ${
                    activeTab === "text-to-issue" ? "bg-green-500" : "bg-gray-600/50"
                  }`}
                ></div>
          ...
          <div className="flex-1 p-4 md:p-0 max-w-3xl">
            <div className="border border-gray-600/10 p-2 rounded-xl">
                  ...
                  <div className="mt-16 mb-6">
                    ...
                    <p className="text-gray-400 leading-relaxed">
                      ...
                      <div className="absolute inline-block bg-green-500/10 text-green-500 border border-blue-500 h-5 rounded-md font-medium mb-3 mr-1">
                        <div className="absolute -top-2 -right-[1.85rem] bg-blue-500 text-white text-xs">quinn</div>
                      </div>
                      documents. Add <span className="font-bold">**style**</span> and{" "}
                      <span className="text-gray-300">##structure</span> with rich-text formatting options.
                    </p>
                  </div>
                  ...
                  <div className="space-y-4 mt-12">
                    {[...Array(4)].map((_, i) => (
                      <div key={i} className="flex flex-col space-y-2">
                        ...
                        {i % 2 === 0 && <div className="h-2 bg-gray-800/50 rounded-full w-[70%]"></div>}
                      </div>
                    ))}
                  </div>
                </div>
