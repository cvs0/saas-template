        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex flex-col md:flex-row md:justify-center md:items-center items-start gap-16 px-10 text-start md:text-center">
            ...
            <Link href="#" className="group">
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-semibold mt-4 max-w-[500px] lg:max-w-[1000px] mb-10">
                Set the product direction
              </h2>
            </Link>
          </div>
          <p className="text-gray-400 text-lg max-w-[320px] mr-[22rem] mb-[-200px] z-20 relative">
            {" "}
          ...
          <div className="rounded-lg relative z-10 overflow-hidden">
            <Image
              ...
              width={1800}
              height={1200}
              className="max-w-[2000px] rounded-lg shadow-2xl object-cover scale-190 md:scale-110 lg:scale-100 -mt-10 z-10"
              priority
              style={{
                WebkitMaskImage:
          ...
          <div className="w-full border-t border-gray-400/10 -mt-20">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 divide-y md:divide-y-0 md:divide-x divide-gray-400/10 max-w-screen-lg mx-auto">
              ...
              <div className="p-6 relative">
                <div className="mr-15 z-20 relative">
                  <h3 className="text-xl font-semibold text-white">
                    Project updates
                  </h3>
                  <p className="text-gray-400 max-w-[255px]">
                ...
                <div className="relative mt-6 mr-5">
                  ...
                  <div className="relative flex justify-end perspective-[1500px]">
                    {/* Tilted Cards Stack */}
                    <div className="absolute w-[300px] h-[120px] mt-10 bg-gray-600/10 ring-[1px] ring-gray-700/40 backdrop-blur-2xl rounded-xl -skew-y-8 shadow-lg transition-transform duration-300 ease-in-out hover:translate-y-[-25px] hover:bg-gray-400/11 z-20">
                      <div className="h-full w-full flex flex-col pointer-events-none">
                        <h1 className="p-4 flex items-center flex-shrink-0">
                          ...
                          <span className="text-red-500 ml-2">Off Track</span>
                        </h1>
                    ...
                    <div className="absolute w-[300px] h-[120px] mt-20 bg-gray-600/10 ring-[1px] ring-gray-700/40 backdrop-blur-2xl rounded-xl translate-x-10 -skew-y-8 shadow-lg transition-transform duration-300 ease-in-out hover:translate-y-[-25px] hover:bg-gray-400/11 z-20">
                      <div className="h-full w-full flex flex-col pointer-events-none">
                        <h1 className="p-4 flex items-center flex-shrink-0">
                          <div className="bg-yellow-700/50 text-white p-[3px] rounded-full">
                            <TrendingUpDown className="w-3 h-3 text-yellow-500" />
                          </div>
                          <span className="text-yellow-500 ml-2">At risk</span>
                        </h1>
                    ...
                    <div className="absolute w-[300px] h-[120px] mt-30 bg-gray-600/10 ring-[1px] ring-gray-700/40 backdrop-blur-lg rounded-xl translate-x-20 -skew-y-8 shadow-lg transition-transform duration-300 ease-in-out hover:translate-y-[-25px] hover:bg-gray-400/11 z-20">
                      <div className="h-full w-full flex flex-col pointer-events-none">
                        <h1 className="p-4 flex items-center flex-shrink-0">
                          <div className="bg-green-700/50 text-white p-[3px] rounded-full">
                            <TrendingUp className="w-3 h-3 text-green-500" />
                          </div>
                          <span className="text-green-500 ml-2">On Track</span>
                        </h1>
